...
function create_renderer(){
	...
	// renderer.setClearColor( 0x000000, 0.0 ); // Commented out as it stops the background from Displaying
...
function add_gradient_background() {
    ...
    var gradientTexture = textureLoader.load(
        'background.jpg',
        function(texture) {
    ...
    // Create a large sphere geometry and a material using this texture
    var skyGeometry = new THREE.SphereGeometry(500, 60, 40);
    var skyMaterial = new THREE.MeshBasicMaterial({map: gradientTexture, side: THREE.BackSide});

    // Create a mesh using this geometry and material, and add it to the scene
    var skyBox = new THREE.Mesh(skyGeometry, skyMaterial);
    scene.add(skyBox);
}

export{init,animate,getMouseMeshList,setBulbState,setBulbGroupState,getLightState,getLightGroupState,getCamera,add_gradient_background};
